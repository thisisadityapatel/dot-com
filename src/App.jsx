    ...
    <div className="container">
      ...
      <footer className="footer">
        <p className="footer-text">
          <span className="dot-ripple">●</span> Checkout what my folks <a href="https://www.nish7.io/" target="_blank" rel="noopener noreferrer">Nishil</a> and <a href="https://neelfaganiya.vercel.app" target="_blank" rel="noopener noreferrer">Neel</a> are up to.
        </p>
