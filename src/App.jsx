    ...
    <div className="container">
      ...
      <footer className="footer">
        <p className="footer-text">
          <span className="dot-ripple">●</span> Checkout what my folks <a href="https://www.nish7.io/" target="_blank" rel="noopener noreferrer">Nishil</a>, <a href="https://neelfaganiya.vercel.app" target="_blank" rel="noopener noreferrer">Neel</a> & <a href="https://www.bhavyamuni.com/" target="_blank" rel="noopener noreferrer">Bhavya</a> are up to.
        </p>
